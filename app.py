...
def create_app(weapons_repository, armors_repository, npc_repository, testing: bool = False):
    app = Flask(__name__)
    app.testing = testing
    ...
    register_api(NPCAPI, "npc_api", "/npc", app, npc_repository)
...
if __name__ == "__main__":
    ...
    npc_repository = JSONNPCRepository("data/NPC.json")
    app = create_app(weapons_repository, armors_repository, npc_repository)
    app.run()
